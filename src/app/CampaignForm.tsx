...
export default function CampaignForm() {
  ...
  return (
    <div className="p-6 max-w-md mx-auto bg-card rounded-xl shadow-md">
      <h3 className="text-xl font-semibold mb-4 text-center text-foreground">Create a Campaign</h3>
