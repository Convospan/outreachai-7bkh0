...
import { CreateAccountPopup } from '@/components/auth/CreateAccountPopup';
...
export default function Home() {
  ...
  return (
    <>
      <CreateAccountPopup open={isCreateAccountOpen} onOpenChange={setIsCreateAccountOpen} />
      <div className="min-h-screen flex flex-col">
        ...
        <header className="grid grid-cols-[1fr_auto] items-center px-6 py-4 sm:px-8 lg:grid-cols-[1fr_auto_1fr]">
          ...
          <div className="justify-self-end">
            <Button variant="default" size="lg" onClick={() => setIsCreateAccountOpen(true)}>
                Get Started
            </Button>
          </div>
        </header>
        <main className="flex-grow px-4 pb-4 sm:mt-6 sm:px-6 sm:pb-6 space-y-12"> {/* Use flex-grow and vertical spacing */}
          ...
          <section className="relative mx-auto w-full max-w-7xl">
            ...
            >
              ...
              <Button variant="secondary" size="lg" onClick={() => setIsCreateAccountOpen(true)}>
